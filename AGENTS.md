...
**Use this as your blueprint** when building a custom code agent system. Chapters are **reference**, not a dependency graph: implement the minimal loop (Ch 01–02), add permissions (03), execution scope (04), then add features from the concept index as required.

**Full potential architecture (one diagram):** [18-arch-overview](18-arch-overview/) shows how subsystems connect end-to-end—user/IDE, query engine, compaction and recovery, tools, services (MCP, memory, API, analytics), and the permission layer. It is a **reference layout** drawn from production patterns; use the staged steps below and the concept index to choose what you need.

## Quick Navigation

### If you are building a code agent from scratch

Read these 5 chapters in order — they give you the minimal viable architecture:
...
4. **[Chapter 04: Execution Scope](04-execution-scope/)** — Filesystem, network, and tool boundaries; worktrees; sandbox layers
5. **[Chapter 05: System Prompt](05-system-prompt/)** — How to assemble and cache system prompts
...
| I need...                    | Read                                                            |
| ---------------------------- | --------------------------------------------------------------- |
| Shell command execution      | [Ch 06: Tool Implementations](06-tool-implementations/)         |
| File editing with validation | [Ch 06: Tool Implementations](06-tool-implementations/)         |
| Scope / sandbox boundaries   | [Ch 04: Execution Scope](04-execution-scope/)                 |
| Streaming API responses      | [Ch 07: Streaming & Messages](07-streaming-and-messages/)       |
| Context window management    | [Ch 08: Context Management](08-context-management/)             |
| Persistent memory            | [Ch 09: Memory System](09-memory-system/)                       |
| MCP server integration       | [Ch 10: MCP Integration](10-mcp-integration/)                   |
| Nested agent spawning        | [Ch 11: Subagents](11-subagents/)                               |
| Multi-agent coordination     | [Ch 12: Multi-Agent Coordination](12-multi-agent-coordination/) |
| Extensible skills/plugins    | [Ch 13: Skills & Plugins](13-skills-and-plugins/)               |
| Lifecycle hooks              | [Ch 14: Hooks & Lifecycle](14-hooks-and-lifecycle/)             |
| Fast startup                 | [Ch 15: Startup Optimization](15-startup-optimization/)         |
| Cost tracking                | [Ch 16: Cost & Observability](16-cost-and-observability/)       |
| IDE integration              | [Ch 17: IDE Bridge](17-ide-bridge/)                             |


### If you are optimizing for production

Read Chapters 15–17 before shipping. They cover startup performance, cost management, and IDE integration patterns.
...
→ See [Chapter 11](11-subagents/), `code-samples/cache_sharing.py`
...
→ [Chapter 01](01-agent-loop/) (pipeline + withheld errors), [Chapter 08](08-context-management/) (`circuit_breaker.py`, `auto_compaction.py`)
...
→ See [Chapter 15](15-startup-optimization/), `code-samples/feature_gates.py`
...
→ See [Chapter 12](12-multi-agent-coordination/), `code-samples/file_mailbox.py`
...
→ See [Chapter 16](16-cost-and-observability/), `code-samples/pii_safe_analytics.py`
...
→ See [Chapter 10](10-mcp-integration/), `code-samples/deferred_tool_discovery.py`
...
→ [Chapter 01](01-agent-loop/) (`prefetch_and_task_budget.py`), [Chapter 07](07-streaming-and-messages/) (`tool_use_exit_signal.py`), [Chapter 08](08-context-management/) (`api_task_budget_remaining.py`)
...
| 4        | [08: Context Management](08-context-management/) | The memory manager — without this, long sessions crash |
| 5        | [11: Subagents](11-subagents/)                   | The cloning system — enables parallel work             |
...
| FS/network/tool scope, worktrees, sandbox layers                                | [04](04-execution-scope/)        |
| System prompt priority, context maps, cache-stable keys                         | [05](05-system-prompt/)            |
| Bash/file/search tool patterns                                                  | [06](06-tool-implementations/)     |
| Message types, streaming assembly, API normalization                            | [07](07-streaming-and-messages/)   |
| Auto-compact, micro-compact, token budget, circuit breaker                      | [08](08-context-management/)       |
| Scoped memory, extraction, entrypoints                                          | [09](09-memory-system/)            |
| MCP lifecycle, config merge, deferred tools                                     | [10](10-mcp-integration/)          |
| Subagent spawn, frozen prompt, sidechain transcript                             | [11](11-subagents/)                |
| File mailbox, permission bridge, contextvars                                    | [12](12-multi-agent-coordination/) |
| Skills frontmatter, plugins, template substitution                              | [13](13-skills-and-plugins/)       |
| Hook registry, lifecycle, execution backends                                    | [14](14-hooks-and-lifecycle/)      |
| Parallel boot, feature gates, lazy import, preconnect                           | [15](15-startup-optimization/)     |
| Cost tracking, PII-safe analytics, telemetry context                            | [16](16-cost-and-observability/)   |
| Bridge framing, session backoff, JWT                                            | [17](17-ide-bridge/)               |
...
You can walk the repo **in chapter order (01→18)** for a complete tour, or ship a **minimal agent first** by finishing **01–05**, then layering **06–10** (core systems), **11–14** (advanced patterns), and **15–17** (production) as needed. Below, **one step groups several chapters**; each chapter has its own **Build your own** and `code-samples/` entry points.
...
### Step 2: Permissions, execution scope, and system prompt (Chapters [03](03-permission-system/)–[05](05-system-prompt/))

Implement `permission_checker.py` (and `permission_modes.py`, `speculative_classifier.py` as you harden rules). Add scope checks (`filesystem_scope.py`, `network_scope.py`, `tool_scope.py`, `sandbox_config.py`, `worktree_isolation.py` as needed). Build `prompt_assembly.py`, `context_builder.py`, and cache-safe prompt parameters.

### Step 3: Tool implementations and streaming (Chapters [06](06-tool-implementations/)–[07](07-streaming-and-messages/))
...
### Step 4: Context, memory, and MCP (Chapters [08](08-context-management/)–[10](10-mcp-integration/))
...
### Step 5: Subagents and multi-agent coordination (Chapters [11](11-subagents/)–[12](12-multi-agent-coordination/))
...
### Step 6: Skills, plugins, and hooks (Chapters [13](13-skills-and-plugins/)–[14](14-hooks-and-lifecycle/))
...
### Step 7: Production hardening (Chapters [15](15-startup-optimization/)–[17](17-ide-bridge/))
...
Together, these seven steps cover **all 18 chapters** in the same part groupings as the book: foundations (01–05), core systems (06–10), advanced patterns (11–14), production (15–17), plus reference [18](18-arch-overview/) for the end-to-end diagram.
